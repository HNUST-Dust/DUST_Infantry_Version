...
uint32_t Verify_CRC16_Check_Sum(const uint8_t * pchMessage, uint32_t dwLength)
{
    ...
    {
     //   printf("pchMessage nullptr or dwLength <= 2\n");
        return false;
    }

   // printf("Verifying CRC for length: %u\n", dwLength);
   // printf("Data: ");
    ...
    //printf("Calculated CRC: 0x%04X, Received CRC: 0x%02X%02X\n",
    //       w_expected, pchMessage[dwLength-1], pchMessage[dwLength-2]);
